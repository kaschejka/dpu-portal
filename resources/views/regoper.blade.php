<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
             {{ __('Подтянуть к выбранным номерам оператора и регион из данных по ФАС') }}
        </h2>
    </x-slot>
...
<br>
    ...
    link.href = url;
    link.setAttribute('download', 'exportRegionOperator.xlsx'); //or any other extension
    ...
    link.click();
         ...
         if (numberFile == true && document.getElementById("rfile").checked) {
           ...
           axios.post('api/numfas', formData, {
           responseType: 'blob',
           headers: {
...
axios.post('api/numfas', formData, {
    ...
    name: "exportRegionOperator.xlsx",
    sheet: {
      name: "Sheet 1"
    }
  });
